...
var Clock = /** @class */ (function () {
    ...
    Clock.prototype.startClock = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                setInterval(function () { self.setTimeFromApi(); }, 10000);
                return [2 /*return*/];
            });
        });
    };
    ...
    Clock.prototype.setTimeFromApi = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get("http://worldtimeapi.org/api/timezone/America/Bogota", { timeout: 5000 }).catch(function (error) {
                            Logger_1.clockLogger.error("Something went wrong with the GET action on the API, trying again...");
                        })];
                    case 1:
                        response = _a.sent();
                        if (response) {
